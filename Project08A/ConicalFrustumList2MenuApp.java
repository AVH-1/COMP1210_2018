...
/**
   ...
   public static void main(String[] args) throws FileNotFoundException {
      ...
      ConicalFrustum[] aLCF = new ConicalFrustum[20];
      String listName = "*** no list name assigned ***";
      int numConicalFrustums = 0;
      ConicalFrustumList2 cFL = new ConicalFrustumList2(listName, aLCF, 
         numConicalFrustums);
      ...
      do {
         ...
         switch (userInChar) {
            ...
            case 'D':
               ...
               System.out.print("\tLabel: ");
               label = scanInput.nextLine();
               ConicalFrustum cFF = cFL.deleteConicalFrustum(label);
               if (cFF != null) {
